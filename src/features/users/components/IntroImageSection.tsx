...
export default function IntroImageSection() {
  return (
    <section className='flex flex-col md:flex-grow md:relative md:pt-10'>
      <section className='gap-3 z-50 will-change-transform'>
        ...
        <p className='text-gray5 dark:text-gray4 body-md z-50 md:text-center'>
